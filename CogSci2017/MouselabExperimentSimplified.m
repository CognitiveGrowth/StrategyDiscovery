classdef MouselabExperimentSimplified < MDP
    ...
    methods
        function mdp=MouselabExperimentSimplified()
        ...
        function [state_action_features,mdp]=extractStateActionFeatures(mdp,state,action)
            ...
            state_action_features=[mdp.myopicVOC(state,action)];%[1;state_features;action_features];
